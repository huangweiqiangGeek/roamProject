...
<script type="text/javascript"
	src="framework/jquery-easyui-1.3.2/locale/easyui-lang-zh_CN.js"></script>
<script type="text/javascript"
	src="framework/jquery-easyui-1.3.2/plugins/jquery.tree.loader.js"></script>
...
<body>
	<form id="submitForm" name="submitForm" action="dccUpload/uploadDcc" enctype="multipart/form-data"
		...
		<div align="center">
			<fieldset style="width: 620px; height: 330px;">
				<legend>DCC消息上传</legend>
				<div style="width: 580px; height: 320px;">
					<table style="height: 100%;">
						<tr>
							<td colspan="6" align="center">
								<div style="height: 100%;">
									<table style="height: 100%;">
										<tr>
											<td><span id=span1><input type="file" class="a-upload2" name="file"></span>
											</td>
										</tr>
										<tr>
											<td><span id=span2><input type="file" class="a-upload2" name="file"></span>
											</td>
										</tr>
										<tr>
											<td><span id=span3><input type="file" class="a-upload2" name="file"></span>
											</td>
										</tr>
										<tr>
											<td><span id=span4><input type="file" class="a-upload2" name="file"></span>
											</td>
										</tr>
										<tr>
											<td><span id=span5><input type="file" class="a-upload2" name="file"></span>
											</td>
										</tr>
									</table>
								</div>
						...
						<tr>
							<td colspan="3" align="center"><a
								href="javascript:sumitMethod()" class="easyui-linkbutton"
								iconCls="icon-upload">上传</a></td>
							<td colspan="2" align="center"><a
								href="javascript:resetMethod2()" class="easyui-linkbutton"
