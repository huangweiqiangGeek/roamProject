...
<body marginheight="0" marginwidth="0" style="overflow: auto">
	<div id="tb" style="padding:5px;height:auto">
		<div>
			<span>媒介类型: C-IC卡</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<span>媒介编号: ${mediumNo }</span>
		</div>
	</div>
	<div style="margin:10px 0;"></div>
	<table id="dgd" class="easyui-datagrid" title="" data-options="
				toolbar:'#tb',rownumbers:true,singleSelect:true,idField:'id',autoRowHeight:false,pagination:true,pageSize:10,url:'busCards/queryPlat_No?mediumNo=${mediumNo }'">
		<thead>
			<tr>
				<th field="plat_no" width="80">车牌号</th>
				...
				<th field="create_user_name" width="90" align="right">创建者</th>
				<th field="create_time_show" width="120" align="right">创建时间</th>
				<th field="update_user_name" width="90" align="right">更新者</th>
