...
<script type="text/javascript" src="pages/useCaseManage/js/createUseCase.js?04"></script>
<script type="text/javascript">
$(function(){
	if(!isNull($("#id").val())){
		updateInit();
...
<body style="overflow: no;padding:10px;">
			...
			<table width="100%"  border="0" style="border:1px solid #C1DAD7;" cellspacing="0" cellpadding="0">
				<tr valign="top">
					<td width="100%" valign="top">
						...
						<table id="dg" class="easyui-datagrid" data-options="rownumbers:true,singleSelect:true,selectOnCheck:false,checkOnSelect:false" title="" data-options="" style="height:310px;">
							<thead>
								<tr>
								</tr>
							</thead>
	...
	<div>
		...
		<input type="hidden" id="uCNumber" name="uCNumber" value="${useCase.uCNumber }">
		<div id="dSubject" style="width:100%;height:237px;/* display:inline-block; */border:1px solid #C1DAD7;margin-bottom:5px;">
			...
			<table width="49%" style="float:left" border="0" cellspacing="0" cellpadding="0"
				...
				<%-- <tr>
					<th><font color="#ff0a29">*</font>用例编号：</th>
