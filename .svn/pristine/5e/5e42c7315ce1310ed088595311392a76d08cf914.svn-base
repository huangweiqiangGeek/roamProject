    ...
    <form id="addOrUpateForm" action="commConfig/save"  method="post">
    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable" id="tbconent">
    		...
    		<tr>
    			...
    			<td colspan="5">
    				<input type="password" class="easyui-validatebox"  id="hostPassWord"  data-options="required:true,missingMessage:'请输入密码'"  name="hostPassWord" value="${commConfig.hostPassWord }" style="width:260px" maxlength="20"/>
    			</td>
    		</tr>
    		<tr>
