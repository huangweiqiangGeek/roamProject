...
<body marginheight="0" marginwidth="0" style="overflow: auto">
	...
	<table id="dg" class="easyui-datagrid" title="" data-options="
				toolbar:'#tb',rownumbers:true,singleSelect:true,idField:'id',autoRowHeight:false,pagination:true,pageSize:10,url:'custDist/queryDistList'">
		<thead>
			<tr>
				...
				<th field="status" width="100">单据状态</th>
				<th data-options="formatter:nameFormatter1" field="id" width="80" >操作</th>
			</tr>
		</thead> 
	</table>
