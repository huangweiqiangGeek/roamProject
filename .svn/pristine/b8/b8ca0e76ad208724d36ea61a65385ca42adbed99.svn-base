...
<script type="text/javascript" src="pages/useCase/js/list.js"></script>
<style>
	.tableHeader{
...
<tr valign="top">
	<td width="100%" valign="top">
		...
		class="tableHeader">
		 <span  style="font-weight: bold;display:inline-block;margin-left:20px;">项目名称：</span><span 
		 style="display:inline-block;margin-right:30px;color:#ff3030">&nbsp;&nbsp;&nbsp;${proName}</span>
		  <span  style="font-weight: bold;">项目编号：</span><span style="color:#ff3030">&nbsp;&nbsp;&nbsp;${proNumber}</span>
		</div>
		...
		<table id="dg" class="easyui-datagrid" title="" data-options="url:'useCase/listPage?proID=${proID }&uCUserID=${uCUserID }&isPass=${isPass }',toolbar:'#tb',rownumbers:true,idField:'id',autoRowHeight:false,pagination:true,pageSize:10">
			<thead>
				<tr>
					...
					<th field=uCUserID width="110">用户号码</th>
					<th field=uCName width="200">用例名称</th>
					<th field=uCNumber width="180">用例编号</th>
					<th field=uCScene width="180">业务场景</th>
					<th align="center" field="statusName" width="80">用例状态</th>
