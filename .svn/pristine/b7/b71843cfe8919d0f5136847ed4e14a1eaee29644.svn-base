...
<body marginheight="0" marginwidth="0" style="overflow: auto">
	...
	<table id="dg" class="easyui-datagrid" title="" data-options="
		...
		<thead>
			<tr>
				...
				<th field="contact_phone" width="100" align="right">联系电话</th> -->
				<th field="customs_code_name" width="70">主管海关</th>
				<th field="customs_code" width="100">主管海关代码</th>
				<th field="busic_no" width="120">IC编号</th>
	...
	<div id="win_div" title="车辆变更" class="easyui-dialog" data-options="iconCls:'icon-save'" style="width:800px;height:400px;padding:10px">
